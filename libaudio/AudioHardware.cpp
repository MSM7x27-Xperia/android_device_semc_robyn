...
//#define LOG_NDEBUG 0
#define LOG_TAG "AudioHardwareSONY"
#include <utils/Log.h>
...
status_t AudioHardware::setMasterVolume(float v)
{
    ...
    set_volume_rpc(SND_DEVICE_HANDSET_CL, SND_METHOD_VOICE, 1, m7xsnddriverfd);
    set_volume_rpc(SND_DEVICE_FARFIELD_CL, SND_METHOD_VOICE, 1, m7xsnddriverfd);
    ...
    set_volume_rpc(SND_DEVICE_TTY, SND_METHOD_VOICE, 1, m7xsnddriverfd);
    set_volume_rpc(SND_DEVICE_VCO, SND_METHOD_VOICE, 1, m7xsnddriverfd);
    ...
    if (new_snd_device == -1) {
        ...
        if ((mTtyMode != TTY_OFF) && (mMode == AudioSystem::MODE_IN_CALL) &&
            ...
            if (mFmRadioEnabled) {
                ...
                new_snd_device = SND_DEVICE_HEADSET_FM;
